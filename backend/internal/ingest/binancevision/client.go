...
func (c *Client) fetchDailyArchive(ctx context.Context, symbol string, request provider.Request, day time.Time) ([]candle.Candle, error) {
	path := fmt.Sprintf(
...
func (c *Client) fetchArchive(ctx context.Context, path string, request provider.Request) ([]candle.Candle, error) {
